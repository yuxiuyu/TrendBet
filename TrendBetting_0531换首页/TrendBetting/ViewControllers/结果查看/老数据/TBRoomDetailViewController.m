//
//  TBResultRoomDetailViewController.m
//  TrendBetting
//
...
#import "TBRoomDetailViewController.h"


@interface TBRoomDetailViewController ()<UITableViewDelegate>
{
...
@implementation TBRoomDetailViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self performSegueWithIdentifier:@"showRoomDetail_MonthVC" sender:@{@"selectedTitle":dataArray[indexPath.row],@"roomStr":_selectedTitle,@"winCountArray":dateDic[dataArray[indexPath.row]]}];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"showRoomDetail_MonthVC"])
    {
