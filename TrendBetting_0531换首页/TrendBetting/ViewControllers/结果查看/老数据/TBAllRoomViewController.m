...
#import "TBAllRoomViewController.h"
#import "TBFileRoomResult_entry.h"

@interface TBAllRoomViewController ()
{
...
@end
@implementation TBAllRoomViewController
...
{
    roomCollectionViewCell*cell=[collectionView dequeueReusableCellWithReuseIdentifier:@"roomCollectionIdentifier" forIndexPath:indexPath];
...
{
    [self performSegueWithIdentifier:@"showRoomVC" sender:@{@"selectedTitle":allHouseArr[indexPath.item]}];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"showRoomVC"])
    {
