//
//  TBResultRoomDetail_TimeViewController.m
//  TrendBetting
//
...
#import "TBRoomDetail_TimeViewController.h"
...
@interface TBRoomDetail_TimeViewController ()<UICollectionViewDelegate>
{
    NSArray*countResult;
    NSArray*xArray;
...
@end
@implementation timeUICollectionViewCell
@end
@implementation TBRoomDetail_TimeViewController
...
{
    timeUICollectionViewCell*cell=[collectionView dequeueReusableCellWithReuseIdentifier:@"timecollectionViewCell" forIndexPath:indexPath];
