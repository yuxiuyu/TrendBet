...
#import "TBGroupAddViewController.h"

@interface TBGroupAddViewController ()
{
    NSArray*dataArray;
...
@implementation TBGroupAddViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell==nil)
    {
        cell=[[UITableViewCell alloc]initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:cellIndentier];
    }
    [cell setAccessoryType:UITableViewCellAccessoryDisclosureIndicator];
    [cell setSelectionStyle:UITableViewCellSelectionStyleNone];
    cell.textLabel.text=dataArray[indexPath.row];
    NSString*str=answerArray[indexPath.row];
    cell.detailTextLabel.text=str.length<=0?[NSString stringWithFormat:@"请选择%@",dataArray[indexPath.row]]:str;
    return cell;
}
